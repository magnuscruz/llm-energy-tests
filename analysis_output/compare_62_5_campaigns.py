...
2026-07-02 is the campaign used in the paper; it predates continuous frequency
logging and relies on a sysfs cap read-back taken at campaign start.
2026-07-27 is a later re-execution that carries 1 Hz frequency telemetry, so it
...
OLD = os.path.join(REPO, "logs", "2026-07-02_48h_62_5_throttling", "deep_aging")
NEW = os.path.join(REPO, "logs", "2026-07-27_48h_62_5_throttling", "deep_aging")
MODELS = ["qwen2.5_0.5b", "phi3_mini", "deepseek-v2_lite", "llama3.1_8b"]
CAP_MHZ = 2188  # 62.5% of the 3.5 GHz E-core maximum
...
def main():
    print(f"{'model':>17} {'metric':>14} {'2026-07-02':>12} {'2026-07-27':>12} {'delta':>9}")
    print("-" * 70)
    for m in MODELS:
    ...
    print("=== cap verification, only possible on the 2026-07-27 campaign ===")
