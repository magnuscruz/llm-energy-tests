...
- **Total memory:** 64 GiB (2 × 32 GiB DIMM, 4800 MHz)
- **Drives:** 256GB KINGSTON SKC6002 (`/dev/sda`), 2TB ST2000DM008-2UB1 (`/dev/sdb`)
- **Network:** Ethernet `I226-V` (eno1), WiFi `AX211` (wlp0s20f3)
- **GPU (integrated):** AlderLake-S GT1
...
- Cores per socket: 14
- Threads per core: 2
- Frequency (max): 4800 MHz, (min): 800 MHz
...
The block below contains the original output used to compile this summary.
...
For the full output, see the original file `PC_hardware_details.txt`.
